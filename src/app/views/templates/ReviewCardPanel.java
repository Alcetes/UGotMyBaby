...
public class ReviewCardPanel extends JPanel {
	...
	public ReviewCardPanel(JScrollPane param, String id) {
		...
		for (Object list : MainController.retrieveReviews(id)) {
//			System.out.println(list);
			@SuppressWarnings("unchecked")
			HashMap<String, Object> map = (HashMap<String, Object>) list;

			southPanel.add(new ReviewCard(map.get("firstname").toString(), map.get("lastname").toString(),
					map.get("rating").toString(), map.get("date").toString(), map.get("description").toString()));
		...
		southScrollPane.setPreferredSize(new Dimension(900, 280));
